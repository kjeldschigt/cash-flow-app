...
try:
    ...
    with st.sidebar:
        ...
        date_range = st.selectbox(
            "Date Range",
            ["Last 7 Days", "Last 30 Days", "Last 90 Days", "Last 6 Months", "YTD", "Last 12 Months"],
            index=1
        )
    ...
    UIComponents.section_header("Key Performance Metrics", "Overview of sales and cash flow performance")
    ...
    if cash_flow_metrics:
        ...
        with col4:
            UIComponents.metric_card(
                "Profit Margin",
                f"{cash_flow_metrics.profit_margin:.1f}%",
                "margin"
            )
        ...
        if analysis_type == "Overview":
            ...
            UIComponents.section_header("Revenue & Cost Breakdown", "Detailed financial analysis")
            ...
            # Monthly Trends
            UIComponents.section_header("Monthly Trends", "Long-term performance analysis")
            ...
            UIComponents.section_header("Performance Comparisons", "Period-over-period analysis")
