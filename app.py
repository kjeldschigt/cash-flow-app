...
try:
    ...
    if not hasattr(container, '_db_connection') or container._db_connection is None:
    ...
    try:
        ...
        class FallbackAuditLogger:
            def log_financial_operation(self, *args, **kwargs):
                logger.warning("Audit logging not available: %s", str(e))
