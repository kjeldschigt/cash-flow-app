...
class RecurringCostService:
    ...
    def get_due_recurring_costs(self, due_date: Optional[date] = None) -> List[RecurringCost]:
    ...
    def process_due_recurring_costs(self) -> List[Cost]:
        ...
        for recurring_cost in due_costs:
            ...
            cost = Cost.create(
                ...
                amount_usd=recurring_cost.amount_expected if recurring_cost.currency == 'USD' else Decimal('0'),
                amount_crc=recurring_cost.amount_expected if recurring_cost.currency == 'CRC' else None,
