...
class PaymentService:
    ...
    def mark_payment_as_paid(self, payment_id: str, payment_date: Optional[date] = None) -> bool:
    ...
    def mark_payment_as_paid(
        ...
        if create_cost_entry:
            cost = Cost.create(
                ...
                amount_usd=actual_amount if schedule.currency == 'USD' else Decimal('0'),
