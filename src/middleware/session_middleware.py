...
class SessionMiddleware:
            ...
            def wrapper(*args, **kwargs):
                ...
                if self.rate_limiter:
                    ...
                    if not rate_result.allowed:
                        st.error(f"❌ Rate limit exceeded. Try again in {rate_result.retry_after} seconds.")
                        st.stop()
    ...
    def login_user(self, user: User, ip_address: str = None, 
        ...
        try:
            ...
            if self.rate_limiter:
                ...
                if not rate_result.allowed:
                    st.error(f"❌ Too many login attempts. Try again in {rate_result.retry_after} seconds.")
                    return False
    ...
    def logout_user(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                logger.info("KeyVaultService cache cleared on logout",
                           user_id=user_id,
            ...
            try:
                ...
                clear_resolver_cache(session_id, user_id)
                logger.info("API Key Resolver cache cleared on logout",
                           user_id=user_id,
                           session_id=session_id)
            except Exception as e:
