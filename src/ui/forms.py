        ...
        with st.form("cost_form"):
            ...
            with col1:
                cost_date = st.date_input(
                    "Date",
                    value=initial.get('date', date.today())
                )
                
                category = FormComponents.category_select(
            ...
            is_paid = st.checkbox(
                "Mark as Paid",
                value=initial.get('is_paid', False)
            )
        ...
        with st.form("payment_schedule_form"):
            ...
            with col2:
                ...
                due_date = st.date_input(
                    "Due Date",
                    value=initial.get('due_date', date.today())
                )
            
            comment = st.text_area(
                "Comment (Optional)",
                value=initial.get('comment', ''),
                max_chars=500
            )
