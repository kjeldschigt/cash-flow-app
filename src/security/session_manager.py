...
class RedisSessionManager:
    ...
    def _decrypt_session_data(self, encrypted_data: str) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.warning("Failed to decrypt session data", error_type=type(e).__name__)
            return {}
                ...
                if encrypted_data:
                    ...
                    if session_dict:
                        sessions.append({
                            ...
                            'user_agent': session_dict.get('user_agent', '')[:50] + "..." if session_dict.get('user_agent') else None
                        })
