...
class APIKeyEncryption:
    ...
    def __init__(self, master_key: Optional[str] = None):
        ...
        logger.info(
            "API key encryption service initialized", operation="encryption_init"
        )
    ...
    def encrypt_api_key(self, api_key: str) -> str:
        ...
        try:
            ...
            logger.error(
                "Failed to encrypt API key", error=str(e), operation="encrypt_api_key"
            )
            raise
    ...
    def decrypt_api_key(self, encrypted_api_key: str) -> str:
        ...
        try:
            ...
            logger.info("API key decrypted successfully", operation="decrypt_api_key")

            return api_key

        except Exception as e:
            logger.error(
                "Failed to decrypt API key", error=str(e), operation="decrypt_api_key"
            )
            raise
